...
func (p *BitBucketServerProvider) UpdatePullRequest(ctx context.Context, repoURL string, number int, options UpdatePullRequestOptions) (*PullRequest, error) {
	ggp := GoGitProvider{}
...
func (p *BitBucketServerProvider) Name() string {
	return BitBucketServerProviderName
}
