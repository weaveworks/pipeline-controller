...
func (g GoGitProvider) CreatePullRequest(ctx context.Context, log logr.Logger, req createPullRequestRequest, repo gitprovider.OrgRepository) (gitprovider.PullRequest, error) {
...
func (g GoGitProvider) ParseBitbucketServerURL(url string) (*gitprovider.OrgRepositoryRef, error) {
...
func (g GoGitProvider) GetBitbucketRepository(ctx context.Context, log logr.Logger, client gitprovider.Client, url string) (gitprovider.OrgRepository, error) {
	ref, err := g.ParseBitbucketServerURL(url)
	if err != nil {
		return nil, err
	}
...
func (g GoGitProvider) UpdatePullRequest(ctx context.Context, repo gitprovider.OrgRepository, number int, options gitprovider.EditOptions) (*PullRequest, error) {
	pr, err := repo.PullRequests().Edit(ctx, number, options)
	if err != nil {
