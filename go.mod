module github.com/weaveworks/pipeline-controller
...
// this is necessary as upstream github.com/fluxcd/pkg/git/gogit needs this specific version
...
require (
	...
	github.com/fluxcd/image-reflector-controller/api v0.20.1 // indirect
